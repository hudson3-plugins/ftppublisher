...
public class FTPSite {
	...
	public void upload(FilePath filePath, Map<String, String> envVars, PrintStream logger) throws IOException, InterruptedException,
	    SftpException {
